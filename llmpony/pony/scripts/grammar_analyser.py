...
import llmpony.pony.utilities.algorithm.command_line_parser as parser
from llmpony.pony.representation.grammar import Grammar
from llmpony.pony.utilities.fitness.math_functions import sci_notation
...
def main(command_line_args):
    ...
    grammar = Grammar(os.path.join("PonyGE2", "grammars", params['GRAMMAR_FILE']))
