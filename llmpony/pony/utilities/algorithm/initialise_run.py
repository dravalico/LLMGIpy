...
from llmpony.pony.utilities.stats.file_io import generate_folders_and_files
...
def get_fit_func_imports():
    ...
    if isinstance(params[op], list):
        ...
        from llmpony.pony.fitness.base_ff_classes.moo_ff import moo_ff
...
def return_attr_from_module(module_name, attr_name):
    ...
    try:
        # Import module.
        module = importlib.import_module("llmpony.pony." + module_name)
