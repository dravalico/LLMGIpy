...
import numpy as np
import pandas as pd
from llmpony.pony.utilities.stats.trackers import first_pareto_list
from llmpony.pony.utilities.stats.file_io import create_results_folder_path, BASE_PATH
...
def save_plot_from_data(data, name):
    ...
    # Save plot and close.
    plt.savefig(path.join(create_results_folder_path(BASE_PATH, params, True, True), (name + '.pdf')))
    plt.close()
