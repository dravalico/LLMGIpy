...
from llmpony.pony.fitness.supervised_learning.supervised_learning import supervised_learning
from llmpony.pony.utilities.fitness.error_metric import Hamming_error
