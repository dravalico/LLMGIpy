...
import json
import itertools
from llmpony.llm.functions.ponyge.improvement_files_generator import create_txt_population_foreach_json, create_params_file
import threading
import os
...
def generate_impr_files():
    ...
    if cmd_args.input_params_ponyge is not None:
        ...
        output_file.writelines([lol.replace('PonyGE2/parameters/', '') + '\n' for lol in all_impr_paths])
        output_file.close()
