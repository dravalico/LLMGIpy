...
import llmpony.llm.models as models
import llmpony.llm.testers as testers
from llmpony.llm.testers.ModelTester import ModelTester
from llmpony.llm.testers.DatasetLoader import DatasetLoader
import llmpony.llm.testers
import os
os.environ['TOKENIZERS_PARALLELISM'] = 'false'

for llm_macro_category in llmpony.llm.models.all_llms_macro_categories:
    exec(f'from llmpony.llm.models.{llm_macro_category} import {llm_macro_category}')
